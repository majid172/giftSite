                ...
                <div>
                    ...
                    <form action="{{ route('cart.store') }}" method="POST">
                        ...
                        <div class="flex gap-4">
                            <!-- Add to Cart (Teal/Green) - Full Width since Buy Now removed -->
                            <button type="submit" name="action" value="add_to_cart" class="w-full bg-teal-700 hover:bg-teal-800 text-white font-bold py-4 rounded-full shadow-lg shadow-teal-700/20 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2 text-lg" {{ $product->stock <= 0 ? 'disabled' : '' }}>
