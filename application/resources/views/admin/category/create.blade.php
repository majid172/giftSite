...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between gap-4">
        <div>
            <h1 class="text-3xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Add Category</h1>
            <p class="text-base-content/70 mt-1">Create a new category for your products</p>
        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="aspect-square relative w-full rounded-2xl border-2 border-dashed border-base-content/20 hover:border-primary transition-colors flex flex-col items-center justify-center bg-base-200/30 overflow-hidden group hover:bg-base-200/50 cursor-pointer" onclick="document.getElementById('image').click()">
                            <!-- Upload Placeholder -->
                            <div class="text-center p-6 transition-all duration-300 group-hover:scale-105" id="upload-placeholder">
                            ...
                            <div id="preview-overlay" class="hidden absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div class="space-y-6">
                        <div class="form-control w-full">
                            ...
                            <input type="text" name="name" id="name" class="input input-bordered w-full h-12 focus:input-primary" value="{{ old('name') }}" placeholder="e.g. Summer Collection" required>
                            @error('name')
                        ...
                        <div class="form-control w-full">
                            ...
                            <textarea name="description" id="description" class="textarea textarea-bordered w-full h-32 leading-normal focus:textarea-primary resize-none" placeholder="Briefly describe this category...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-error text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
