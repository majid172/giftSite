...
<div class="py-8">
    <div class="mb-8">
        <h1 class="text-4xl font-serif font-bold text-emerald-950">All Categories</h1>
        <p class="text-stone-500 mt-2 text-lg">Explore our diverse collection of premium gifts, curated for every occasion.</p>
    </div>
