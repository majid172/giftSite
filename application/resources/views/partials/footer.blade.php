<footer style="background-color: #0e1110ff; background-image: linear-gradient(rgba(8, 10, 10, 0.9), rgba(8, 10, 10, 0.95)), url(&quot;data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 30c0-10 10-20 20-20s10 10 10 20-10 20-20 20-20-10-20-20z' fill='%2310B981' fill-opacity='0.05' fill-rule='evenodd'/%3E%3C/svg%3E&quot;);" class="text-white pt-16 pb-24 lg:pb-8">
